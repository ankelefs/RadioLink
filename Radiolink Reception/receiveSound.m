...
while true
    ...
    rxSignal_CoarseFrequencySynchronized = symbolSynchronizerObject(rxSignal_CoarseFrequencySynchronized);

    
    % Frame synchronization.
    [rxSignal_Frames, partialPacket, packetCompletions, dataStartIndexes] = extractPackets( ... 
        rxSignal_CoarseFrequencySynchronized, ...
        barkerSequence, ...
        modulationOrder, ...
        informationDataSize, ...
        overlapBuffer, ...
    ...
    audioDataHandler(rxSignal_Frames, packetCompletions, packetScalingFactor, dataStartIndexes, fineSynchronizerObject);
